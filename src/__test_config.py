...
interp_base = True  # interpolate base observations

# ------------ Kalman Filter Statistics ------------------------
eratio = [300, 300]  # ratio between psuedorange noise and carrier phase noise for L1, L2
efact = {uGNSS.GPS: 1.0, uGNSS.GLO: 1.0, uGNSS.GAL: 1.0}  # relative weighting of each constellation
...
armode = 1  # 0:off, 1:continuos,3:fix-and-hold
...
sing_elmin = 15  # minimum elevation (degrees)
...
skip_sig_tbl = {uGNSS.GPS: [rSIG.L1X, rSIG.L1W, rSIG.L2W, rSIG.L2C, rSIG.L5Q, rSIG.L5X, rSIG.L7Q, rSIG.L7X],
                # skip these obs
                uGNSS.GLO: [rSIG.L1X, rSIG.L1W, rSIG.L2W, rSIG.L2C, rSIG.L5Q, rSIG.L5X, rSIG.L7Q, rSIG.L7X],
                uGNSS.GAL: [rSIG.L1X, rSIG.L1W, rSIG.L2W, rSIG.L2C, rSIG.L5Q, rSIG.L5X, rSIG.L7Q, rSIG.L7X],
                uGNSS.QZS: [rSIG.L1X, rSIG.L1W, rSIG.L2W, rSIG.L2C, rSIG.L5Q, rSIG.L5X, rSIG.L7Q, rSIG.L7X]}

# set these from table below
freq_ix0 = {uGNSS.GPS: 0}  # L1
freq_ix1 = {uGNSS.GPS: 1}  # L2/E5b
